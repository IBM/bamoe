...
function loadEditor() {
  ...
  const editor = DmnEditor.open({
    ...
    resources: new Map([
      ["path1/can-drive-types.dmn", { contentType: "text" as any, content: loadFile("can-drive-types.dmn") }],
      ["path2/loan-pre-qualification.dmn", { contentType: "text" as any, content: loadFile("loan-pre-qualification.dmn") }],
    ]),
    readOnly: false,
  });
