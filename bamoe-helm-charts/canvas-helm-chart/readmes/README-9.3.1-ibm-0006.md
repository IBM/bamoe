...
```console
helm install bamoe-canvas oci://quay.io/bamoe/canvas-helm-chart --version=9.3.1-ibm-0006
```
...
```console
helm pull oci://quay.io/bamoe/canvas-helm-chart --version=9.3.1-ibm-0006 --untar
