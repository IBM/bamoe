# PAMOE Runtime Environment Helm Chart (9.4.1-ibm-0002)
...
```console
helm pull oci://quay.io/bamoe/pamoe-runtime-environment-helm-chart --version=9.4.1-ibm-0002 --untar
...
```console
helm install pamoe-runtime oci://quay.io/bamoe/pamoe-runtime-environment-helm-chart --version=9.4.1-ibm-0002
```
