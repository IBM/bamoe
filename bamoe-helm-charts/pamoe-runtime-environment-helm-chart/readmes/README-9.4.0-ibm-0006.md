# PAMOE Runtime Environment Helm Chart (9.4.0-ibm-0006)
...
```console
helm pull oci://quay.io/bamoe/pamoe-runtime-environment-helm-chart --version=9.4.0-ibm-0006 --untar
...
```console
helm install pamoe-runtime oci://quay.io/bamoe/pamoe-runtime-environment-helm-chart --version=9.4.0-ibm-0006
```

## Uninstalling the Chart

To uninstall the `pamoe-runtime` deployment:

```console
helm uninstall pamoe-runtime
```
...
```console
helm install pamoe-runtime oci://quay.io/bamoe/pamoe-runtime-environment-helm-chart --set image.repository=quay.io
```
...
| -------------------------------------------- | ------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------ |
| global.chargedProductValues.productID        | string | `"72984f114b54496a8a44be139154a988"`                                                                                                                                                                                                                    |                                                                                                                                                  |
| global.chargedProductValues.productMetric    | string | `"VIRTUAL_PROCESSOR_CORE"`                                                                                                                                                                                                                              |                                                                                                                                                  |
| global.chargedProductValues.productName      | string | `"IBM Process Automation Manager Open Edition"`                                                                                                                                                                                                         |                                                                                                                                                  |
...
| management_console.image                     | object | `{"account":"bamoe","name":"management-console","pullPolicy":"IfNotPresent","registry":"quay.io","tag":"9.4.0-ibm-0006"}`                                                                                                                               | Image source configuration for the Management Console image                                                                                      |
...
| mcp_server.image                             | object | `{"account":"bamoe","name":"mcp-server","pullPolicy":"IfNotPresent","registry":"quay.io","tag":"9.4.0-ibm-0006"}`                                                                                                                                       | Image source configuration for the MCP Server image                                                                                              |
