# BAMOE Consoles Helm Chart (9.4.0-ibm-0006)
...
```console
helm pull oci://quay.io/bamoe/consoles-helm-chart --version=9.4.0-ibm-0006 --untar
...
<table>
    ...
    <tr>
        <td>management-console.pimMaxBulkIterationsCount</td>
        <td>string</td>
        <td>`&quot;&quot;`</td>
        <td>Overrides The maximum number of bulk requests in one migration operation</td>
    </tr>
    <tr>
        <td>management-console.pimMaxBulkSize</td>
        <td>string</td>
        <td>`&quot;&quot;`</td>
        <td>Overrides the maximum number of process instance ids that can be sent in one request</td>
    </tr>
    <tr>
