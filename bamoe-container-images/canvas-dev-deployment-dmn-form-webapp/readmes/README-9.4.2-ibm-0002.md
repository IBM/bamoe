# BAMOE Canvas Dev Deployment DMN Form Webapp (9.4.2-ibm-0002)
...
```bash
docker run -t -p 8080:8081 -i --rm quay.io/bamoe/canvas-dev-deployment-dmn-formwebapp:9.4.2-ibm-0002
