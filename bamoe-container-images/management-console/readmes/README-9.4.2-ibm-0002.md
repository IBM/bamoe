# BAMOE Management Console (9.4.2-ibm-0002)
...
```bash
docker run -t -p 9091:8080 -i --rm quay.io/bamoe/management-console:9.4.2-ibm-0002
...
```shell
docker run -d -p 9091:8080 -e RUNTIME_TOOLS_MANAGEMENT_CONSOLE_BASE_PATH=bamoe-management-console -e RUNTIME_TOOLS_MANAGEMENT_CONSOLE_USE_APACHE_HTTPD_BASE_PATH_ALIAS=true quay.io/bamoe/management-console:9.4.2-ibm-0002
```