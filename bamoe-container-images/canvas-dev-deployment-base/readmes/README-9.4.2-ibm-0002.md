# BAMOE Canvas Dev Deployment Base (9.4.2-ibm-0002)
...
```bash
docker run -it --rm -e DEV_DEPLOYMENT__UPLOAD_SERVICE_API_KEY=<string> quay.io/bamoe/canvas-dev-deployment-base:9.4.2-ibm-0002 <cmd>
```
