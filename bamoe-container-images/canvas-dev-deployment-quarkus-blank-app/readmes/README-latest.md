# BAMOE Canvas Dev Deployment Quarkus Blank App (9.4.0-ibm-0006)
...
```bash
docker run -t -p 8080:8080 -i --rm -e DEV_DEPLOYMENT__UPLOAD_SERVICE_API_KEY=<string> quay.io/bamoe/canvas-dev-deployment-quarkus-blank-app:9.4.0-ibm-0006
